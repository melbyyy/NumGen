...
#---------------------------------------  
# TIMED QUESTIONS SECTION

    def Timed_Questions():

        def settings_first_addened():

            global minimum_val_1, maximum_val_1

            while True:
                cls()

                print("=== Timed Question Settings ===")

                print("\n[ First Addened Integer Limit ]")

                print()

                print("Please input your desired minimum number.")

                try:
                    user_input = int(input("\n: "))
                    minimum_val_1 = user_input
                    print(minimum_val_1)
                    input(":")
                    break
                except ValueError:
            ...
            while True:
                ...
                print("Please input your desired maximum number.")
            
                try:
                    user_input = int(input("\n: "))
                    maximum_val_1 = user_input
                    print(maximum_val_1)
                    input(":")
                    Timed_Questions()
                except ValueError:
        ...
        def settings_second_addened():

            global minimum_val_2, maximum_val_2
        ...
        def settings_page():
            ...
            global choices_help, choices_back
            
            while True:
                cls()

                settings_choices = ("Change First Addend Integer Limit", "Change Second Addend Integer Limit")

                choices_first_addend = ("1", "First", "first", "F", "f")
                choices_second_addend = ("2", "Second", "second", "S", "s")
                ...
                if user_input in  choices_first_addend:
                    settings_first_addened()
                elif user_input in choices_second_addend:
                    settings_second_addened()
                elif user_input in choices_help:
                    help()
                elif user_input in choices_back:
                    Timed_Questions()
        ...
        def question_format():
            ...
            global minimum_val_1, maximum_val_1, minimum_val_2, maximum_val_2

            num1 = random.randrange(minimum_val_1, maximum_val_1)
            num2 = random.randrange(minimum_val_2, maximum_val_2)

            while True:
                cls()
                print('=== Timed Math Questions ===')
        ...
        def timed_question_start():
            ...
            while True:
                while True:
                    ...
                    print('How many questions are you going to answer?')

                    print("Type 0 to go back")

                    user_input = input("\n: ")

                    if user_input in choices_back or user_input == 0:
                        Timed_Questions()
                        break 

                    try:
                        questions = int(user_input)
                        break
                    except ValueError:
                ...
                for times in range(questions):
                    question_format()

                time_stop = time.time()

                print(f"Your time is: {time_stop-time_start}")
                input(': ')

        while True:
            cls()

            choices = ("Start", "Settings", "Help", "Back")
    ...
    def Num_Gen_Modes():
        ...
        numgen_modes = ("Number Generator", "Operations Generator", "Timed Questions")


        number_generator_choices = ('1', 'NumGen', 'numgen', 'gen', 'num')
        operations_generator_choices = ('2', 'operation', 'operations', 'op', 'ops')
        timed_questions = ("3", "Timed Questions", "timed questions", "TQ", "Tq", "tq")
        choices_help = ("Help", "help","HELP", "?")
        choices_back = ('0', 'Back', 'back', 'B', 'b')
        ...
        while True:
            ...
            if user_input in number_generator_choices:
                ...
                Number_Generator_in_Operation_Format()
            elif user_input in timed_questions:
                Timed_Questions()
            elif user_input in choices_help:
                help()
            elif user_input in choices_back:
